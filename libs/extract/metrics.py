def bundles(bundles):
    ...
    for key, bundle in bundles.items():
        ...
        metadata = extractMetricMetadata(metric=metric, definition=definition, time_options=time_options)
...
def extractMetricsSummary(bundles, time_options):
    ...
    metrics_table_header = "| Metric Name | Value | Units | Description | Sentiment |\n|--------------|-------------|-------------|-------------|-------------|\n"
    metrics_table_rows = '\n'.join(
        f"| {bundles[bundle]['metric']['name']} | {bundles[bundle]['metric']['value']} | {bundles[bundle]['metric']['representation_options']['number_units']['plural_noun']} | {bundles[bundle]['metric']['description']} | {bundles[bundle]['metric']['sentiment']} |"
        for bundle in bundles
    )
...
You have access to {insights_count} AI insights generated by Tableau Pulse
...
def extractMetricMetadata(metric, definition, time_options):
    metadata = f"""
    # Metric Summary
